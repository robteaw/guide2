      ...
      <div className="info">
        ...
        <table>
          ...
          <tr>
            <td>POST</td>
            <td>
              Supported by HTTP and depicts that a web server accepts the data
        ...
        <p>
          Type <b>!</b> then press <b>tab</b> will display like below.
        </p>
        <img src={img1} alt="" className="img1" />

        <h3>Create multiple elements</h3>
        <p>
          Type <b>p*3</b> then press <b>tab</b> will create 3 rows of
          paragraphs.
        </p>
