    ...
    <>
      <div className="info">
        ...
        <ol>
          ...
          <li>
            a stopping condition is the condition that the iterator variable is
            evaluated against— if the condition evaluates to true the code block
            will run, and if it evaluates to false the code will stop.
          </li>
          <li>
